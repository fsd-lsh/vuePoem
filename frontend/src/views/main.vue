...
<style>
    .dash-item { margin:0 0 10px 0; }
    .dash-item > div { border:1px solid #f2f2f2; border-radius:5px; }
    .dash-item > div > p { padding:14px 10px; border-bottom:1px solid #f2f2f2; margin:0; }
    .dash-item > div > .dash-item-cover { padding:10px; }
    .dash-item > div > .dash-item-cover > .dash-item-card > div { padding:5px 15px; border-radius:5px; margin:0 0 10px 0; background-color:#F8F8F8; }
    .dash-item > div > .dash-item-cover > .dash-item-card > div > p { font-size:1rem; }
    .dash-item > div > .dash-item-cover > .dash-item-card > div > .total-group { color:#666; }
    .dash-item > div > .dash-item-cover > .dash-item-card > div > .total-group > .total { font-weight:600; font-size:1.2rem; }
